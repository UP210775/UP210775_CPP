...
int main(){
    ...
    cout<<endl<<"Hasta que numero quieres multilicar:";cin>>multiplicar;
    ...
    cout<<endl;
    cout<<"introduce su numero a multiplicar:";cin>>numero;
    cout<<endl<<"Hasta que numero quieres multiplicae:";cin>>multiplicar;
    ...
    cout<<endl;
    cout<<"introduce su numero a multiplica:";cin>>numero;
    cout<<endl<<"Hasta que numero quieres multiplicar:";cin>>multiplicar;
